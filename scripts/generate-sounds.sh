...
# Sox syntax: sox -n OUTPUT_FILE effects...
generate() {
    local name="$1"
    shift
    echo "  $name.caf"
...
generate "gentle_chime"   synth 2 sine 880 fade 0 2 1.5
generate "soft_bell"       synth 1.5 sine 1046.5 fade 0 1.5 1
generate "morning_tone"    synth 2 sine 659.25 fade 0 2 1.5
generate "digital_beep"    synth 0.5 square 1000 fade 0 0.5 0.3
generate "classic_alarm"   synth 3 sine 440:880 fade 0 3 0.5
generate "pulse"           synth 1 sine 523.25 sine 659.25 fade 0 1 0.5
generate "ripple"          synth 2.5 pluck 440 fade 0 2.5 2
